...
EpochHandler::EpochHandler(uint64_t no_threads) : no_threads(no_threads), global_epoch(0), local_epoch(no_threads) {}
...
void EpochHandler::EpochOperation(uint64_t wid) {
  /* Increase epoch*/
...
void EpochHandler::DeferFreePointer(uint64_t wid, void *ptr) {
