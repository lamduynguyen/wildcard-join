-- Analytical Context: An AI infrastructure researcher wants to profile how developers are compiling, quantizing, and deploying open-weights models in 2025. Model titles on Hacker News contain incredibly dense, regular, yet variable string layouts (e.g., DeepSeek-R1-Distill-Qwen-14B-GGUF, Llama-3.3-70B-Instruct, Qwen2.5-Coder-32B).
SELECT
    CASE
...
WHERE type IN ('1', '5')
  ...
  AND (
       ...
       OR title LIKE '%Llama_3._%_B%GGUF%'
       OR title LIKE '%Llama_3._%_B%_q_%'
