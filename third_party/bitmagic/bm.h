...
public:
    ...
    */
    ...
    reference operator[](size_type n)
    {
        if (n >= size_)
        {
            size_type new_size = (n > bm::id_max / 2) ? bm::id_max : n * 2;
            resize(new_size);
        }
    ...
    inline bool is_ro() const BMNOEXCEPT { return blockman_.arena_; }
                                          ...
                                          bool     value)
{
    ...
    {
        size_type new_size = (right > bm::id_max / 2) ? bm::id_max : right * 2;
        resize(new_size);
    }
